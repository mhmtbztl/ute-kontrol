...
(function (root, factory) {
  ...
  const DEFAULT_LIMITS = Object.freeze({ snapshots: 100, findings: 50, media: 200, placements: 300, benchmarks: 30, analysisRuns: 30, experiments: 30, healthSnapshots: 30 });
  ...
  function buildPropertyRequests(scope = {}, limits = {}) {
    ...
    return {
      ...
      benchmarks: request('property_marketing_benchmarks', '*', 'effective_from', max.benchmarks, valid.propertyId),
  ...
  async function loadMarketingWorkspaceData(client, scope = {}, options = {}) {
    ...
    const result = { listings: [], snapshots: [], findings: [], media: [], placements: [], benchmarks: [], analysisRuns: [], experiments: [], healthSnapshots: [], errors: [] };
