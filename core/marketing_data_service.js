...
(function (root, factory) {
  ...
  const DEFAULT_LIMITS = Object.freeze({ snapshots: 100, findings: 50, media: 200, analysisRuns: 30, experiments: 30 });
  ...
  async function loadMarketingWorkspaceData(client, scope = {}, options = {}) {
    ...
    const result = { listings: [], snapshots: [], findings: [], media: [], analysisRuns: [], experiments: [], errors: [] };
